...
// YOUR CODE STARTS HERE.
        ...
        if($IfacetsegF != '' && $IfacettokF != '' && $IfacetposF != '')
            ...
            if($mode == 'dry')
                scrip("\$conll = conllout(\$IfacettokF,\$IfacetsegF,\$IfacetposF,\$IfacetlemF)");
            else
            ...
            if($mode == 'dry')
                scrip("repeatHttp(\$conll,\$mateParserfile,realpath($lang))");
            else
        ...
        if($Oformatpt)
            ...
            if($mode == 'dry')
                {
                scrip("../bin/bracmat 'get\$\"conll2pt.bra\"' '\$ptfile' '\$mateParserfile'");
                scrip("\$mateParserfile = \$ptfile");
                }
            else
                {
