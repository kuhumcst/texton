...
ServiceURL     : http://localhost/sent	*** TODO make sure your web service listens on this address and that this script is readable for the webserver. ***
Publisher      : CST
ContentProvider: CST
Creator        : Bart Jongejan
InfoAbout      : -
Description    : From Clarin Base Format (enriched with attributes for tokens and segments) extract the sentences and their offsets in the source.
ExternalURI    : 
XMLparms       : 
PostData       : 
Inactive       : 
...
* helper functions *
*******************/
$toollog = '/opt/texton/log/sent.log'; /* Used by the logit() function. TODO make sure the folder exists and is writable. Adapt if needed */
    ...
    function requestFile($requestParm) // e.g. "IfacettokF"
        ...
        if(isset($_REQUEST[$requestParm]))
            ...
            if($handle == false)
                ...
                {
                $tempfilename = tempFileName("sent_$requestParm_");
