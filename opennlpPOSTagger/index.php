...
PassWord       : 
Version        : 1.5.2
Title          : OpenNLP tools PosTagger
ServiceURL     : http://localhost/opennlpPOSTagger	*** TODO make sure your web service listens on this address and that this script is readable for the webserver. ***
Publisher      : Apache
        ...
        if($dodelete)
            ...
            foreach ($tobedeleted as $filename => $dot) 
                ...
                if($dot)
                    ...
                    logit("Delete $filename !");
                    if(unlink($filename))
                        logit("Delete $filename DONE");
                    else
                        logit("Delete $filename FAILED");
                    }
                }
            unset($tobedeleted);
            }
