...
Version        : 3.5
Title          : LibreOffice
ServiceURL     : http://localhost/soffice/	*** TODO make sure your web service listens on this address and that this script is readable for the webserver. ***
...
* helper functions *
*******************/
$toollog = '../log/soffice.log'; /* Used by the logit() function. */
    ...
    function requestFile($requestParm) // e.g. "IfacettokF"
        ...
        if(isset($_REQUEST[$requestParm]))
            ...
            if($handle == false)
                ...
                {
                $tempfilename = tempFileName("soffice_$requestParm_");
...
//        TODO your code!
	...
	// It seems that an absolute path to LibO_Conversion is necessary
        ...
        //$command = "/usr/bin/soffice \"-env:UserInstallation=file://./LibO_Conversion\" --convert-to $outputExtension " . $copied . " --headless --outdir .";// . $workdir;
