    ...
    function requestFile($requestParm) // e.g. "IfacettokF"
        ...
        if(isset($_REQUEST[$requestParm]))
            ...
            if($handle == false)
                ...
                {
                $tempfilename = tempFileName("CSTRTFread_$requestParm_");
...
************************/
        ...
        if( hasArgument("Ifacet") )
            ...
            $echos = $echos . "Ifacettok=$Ifacettok " . "Ifacettxt=$Ifacettxt ";
            }
        ...
        if( hasArgument("Ofacet") )
            ...
            $echos = $echos . "Ofacetseg=$Ofacetseg " . "Ofacetseto=$Ofacetseto ";
            }
 ...
 */
        ...
        if($Ofacetseto && ($OformatplainD || !$Ifacettok))
            {
            if($Olangen)
                $tokentype = "-P ";
            else
