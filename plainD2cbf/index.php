...
function scripinit($inputF,$input,$output)  /* Initialises outputfile. */
    {
    global $fscrip, $plainD2cbffile;
    $fscrip = fopen($plainD2cbffile,'w');
    if($fscrip)
        {
        fwrite($fscrip,"/*\n");
        fwrite($fscrip," * ToolID           : plainD2cbf\n");
        fwrite($fscrip," * Version          : 1\n");
        fwrite($fscrip," * Title            : plain to TEI\n");
        fwrite($fscrip," * ServiceURL       : http://localhost/plainD2cbf\n");
        fwrite($fscrip," * Publisher        : CST\n");
        fwrite($fscrip," * ContentProvider  : CST\n");
        fwrite($fscrip," * Creator          : Bart Jongejan\n");
        fwrite($fscrip," * InfoAbout        : -\n");
        fwrite($fscrip," * Description      : From a plain segmentized and tokenized text file that uses DEL characters to separate tokens that are written together in the input, create a TEI P5 Clarin Base Format text with attributes S and T for segment and token identification.\n");
...
************************/
        ...
        if( hasArgument("Iformat") )
            ...
            $input = $input . ($IformatplainD ? " \$IformatplainD" : "") ;
            }
...
//        TODO your code!
        ...
        if($mode == 'dry')
        {
            ...
            scrip("../bin/bracmat \"get'\\\"f2b.bra\\\"\" \$F \$plainD2cbffile");
        }
        else
        {
