...
ServiceURL     : http://localhost/CST-tagger/	*** TODO make sure your web service listens on this address and that this script is readable for the webserver. ***
Publisher      : CST
ContentProvider: cst.ku.dk
Creator        : Brill
InfoAbout      : http://localhost/download/tagger/
    ...
    function requestFile($requestParm) // e.g. "IfacettokF"
        ...
        if(isset($_REQUEST[$requestParm]))
            ...
            if($handle == false)
                ...
                {
                $tempfilename = tempFileName("BrillTagger-" . $requestParm);
 ...
 */
        ...
        $Ifacetstn = false;	/* Type of content in input is segments,tokens,named entities (Sætningssegmenter,tokens,navne) if true */
        ...
        $Ofacetspo = false;	/* Type of content in output is segments,PoS-tags (Segmenter, PoS-tags) if true */
        ...
        $IfacetsetoPT = false;	/* Style of type of content segments,tokens (Sætningssegmenter,tokens) in input is 0 if true */
        ...
        $OfacetposPar = false;	/* Style of type of content PoS-tags (PoS-tags) in output is (Penn Treebank.PT.)(Parole.Par.)(Parole-Moses.ParMos.)(DSL-tagset.DSL.)(CST new tag setCST_nyt_tagsæt.CSTnyt.)(Universal Part-of-Speech Tagset.Uni.) if true */
        $OfacetposParMos = false;	/* Style of type of content PoS-tags (PoS-tags) in output is (Penn Treebank.PT.)(Parole.Par.)(Parole-Moses.ParMos.)(DSL-tagset.DSL.)(CST new tag setCST_nyt_tagsæt.CSTnyt.)(Universal Part-of-Speech Tagset.Uni.) if true */
        ...
        $OfacetspoPar = false;	/* Style of type of content segments,PoS-tags (Segmenter, PoS-tags) in output is (Penn Treebank.PT.)(Parole.Par.)(Parole-Moses.ParMos.)(DSL-tagset.DSL.)(CST new tag setCST_nyt_tagsæt.CSTnyt.)(Universal Part-of-Speech Tagset.Uni.) if true */
        $OfacetspoParMos = false;	/* Style of type of content segments,PoS-tags (Segmenter, PoS-tags) in output is (Penn Treebank.PT.)(Parole.Par.)(Parole-Moses.ParMos.)(DSL-tagset.DSL.)(CST new tag setCST_nyt_tagsæt.CSTnyt.)(Universal Part-of-Speech Tagset.Uni.) if true */
        ...
        $OfacetstpPT = false;	/* Style of type of content segments,tokens,PoS-tags (segmenter,tokens,PoS-tags) in output is (Penn Treebank.PT.)(Parole.Par.)(Parole-Moses.ParMos.)(DSL-tagset.DSL.)(CST new tag setCST_nyt_tagsæt.CSTnyt.)(Universal Part-of-Speech Tagset.Uni.) if true */
        $OfacetstpPar = false;	/* Style of type of content segments,tokens,PoS-tags (segmenter,tokens,PoS-tags) in output is (Penn Treebank.PT.)(Parole.Par.)(Parole-Moses.ParMos.)(DSL-tagset.DSL.)(CST new tag setCST_nyt_tagsæt.CSTnyt.)(Universal Part-of-Speech Tagset.Uni.) if true */
        $OfacetstpParMos = false;	/* Style of type of content segments,tokens,PoS-tags (segmenter,tokens,PoS-tags) in output is (Penn Treebank.PT.)(Parole.Par.)(Parole-Moses.ParMos.)(DSL-tagset.DSL.)(CST new tag setCST_nyt_tagsæt.CSTnyt.)(Universal Part-of-Speech Tagset.Uni.) if true */
...
************************/
        ...
        if( hasArgument("Ifacet") )
            ...
            $Ifacetstn = existsArgumentWithValue("Ifacet", "stn");
            $Ifacettok = existsArgumentWithValue("Ifacet", "tok");
            $echos = $echos . "Ifacetner=$Ifacetner " . "Ifacetseg=$Ifacetseg " . "Ifacetseto=$Ifacetseto " . "Ifacetstn=$Ifacetstn " . "Ifacettok=$Ifacettok ";
            }
        ...
        if( hasArgument("Ofacet") )
            ...
            $Ofacetspo = existsArgumentWithValue("Ofacet", "spo");
            $Ofacetstp = existsArgumentWithValue("Ofacet", "stp");
            $echos = $echos . "Ofacetpos=$Ofacetpos " . "Ofacetspo=$Ofacetspo " . "Ofacetstp=$Ofacetstp ";
            }
...
*******************************/
        if( hasArgument("Ifacetseto") )
            {
            $IfacetsetoPT = existsArgumentWithValue("Ifacetseto", "PT");
            $echos = $echos . "IfacetsetoPT=$IfacetsetoPT ";
            }
        if( hasArgument("Ofacetpos") )
            ...
            $OfacetposParMos = existsArgumentWithValue("Ofacetpos", "ParMos");
            $OfacetposUni = existsArgumentWithValue("Ofacetpos", "Uni");
            $echos = $echos . "OfacetposDSL=$OfacetposDSL " . "OfacetposPar=$OfacetposPar " . "OfacetposParMos=$OfacetposParMos " . "OfacetposUni=$OfacetposUni ";
            }
        if( hasArgument("Ofacetspo") )
            {
            $OfacetspoPar = existsArgumentWithValue("Ofacetspo", "Par");
            $OfacetspoParMos = existsArgumentWithValue("Ofacetspo", "ParMos");
            $echos = $echos . "OfacetspoPar=$OfacetspoPar " . "OfacetspoParMos=$OfacetspoParMos ";
            }
        if( hasArgument("Ofacetstp") )
            {
            $OfacetstpDSL = existsArgumentWithValue("Ofacetstp", "DSL");
            $OfacetstpPT = existsArgumentWithValue("Ofacetstp", "PT");
            $OfacetstpPar = existsArgumentWithValue("Ofacetstp", "Par");
            $OfacetstpParMos = existsArgumentWithValue("Ofacetstp", "ParMos");
            $OfacetstpUni = existsArgumentWithValue("Ofacetstp", "Uni");
            $echos = $echos . "OfacetstpDSL=$OfacetstpDSL " . "OfacetstpPT=$OfacetstpPT " . "OfacetstpPar=$OfacetstpPar " . "OfacetstpParMos=$OfacetstpParMos " . "OfacetstpUni=$OfacetstpUni ";
            }
