...
function scripinit($inputF,$input,$output)  /* Initialises outputfile. */
    ...
    if($fscrip)
        ...
        fwrite($fscrip," * Title            : Brill tagger\n");
        fwrite($fscrip," * ServiceURL       : http://localhost/BrillTagger/\n");
        fwrite($fscrip," * Publisher        : CST\n");
        fwrite($fscrip," * ContentProvider  : cst.ku.dk\n");
        fwrite($fscrip," * Creator          : Brill\n");
        fwrite($fscrip," * InfoAbout        : https://nlpweb01.nors.ku.dk/download/tagger/\n");
        fwrite($fscrip," * Description      : Part-of-speech tagger: Marks each word in a text with information about word class and morphological features.\n");
...
************************/
        ...
        if( hasArgument("Ilang") )
            ...
            $echos = $echos . "Ilangda=$Ilangda " . "Ilangen=$Ilangen " . "Ilanggml=$Ilanggml " . "Ilangla=$Ilangla ";
            $input = $input . ($Ilangda ? " \$Ilangda" : "")  . ($Ilangen ? " \$Ilangen" : "")  . ($Ilanggml ? " \$Ilanggml" : "")  . ($Ilangla ? " \$Ilangla" : "") ;
            }
        ...
        if( hasArgument("Olang") )
            ...
            $echos = $echos . "Olangda=$Olangda " . "Olangen=$Olangen " . "Olanggml=$Olanggml " . "Olangla=$Olangla ";
            $output = $output . ($Olangda ? " \$Olangda" : "")  . ($Olangen ? " \$Olangen" : "")  . ($Olanggml ? " \$Olanggml" : "")  . ($Olangla ? " \$Olangla" : "") ;
            }
