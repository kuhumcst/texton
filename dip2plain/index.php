...
ServiceURL     : http://obi.cst.sc.ku.dk/dip2plain	*** TODO make sure your web service listens on this address and that this script is readable for the webserver. ***
Publisher      : NoRS
    ...
    function requestFile($requestParm) // e.g. "IfacettokF"
        ...
        if(isset($_REQUEST[$requestParm]))
            ...
            if($handle == false)
                ...
                {
                $tempfilename = tempFileName("dip2plain_$requestParm_");
