...
Version        : 1
Title          : cluster
ServiceURL     : http://localhost/cluster/	*** TODO make sure your web service listens on this address and that this script is readable for the webserver. ***
Publisher      : CST
ContentProvider: CST
 ...
 */
        ...
        $Iformat4col = false;	/* Format in input is four-column list, tab separated (fire kolonner, tab separaret) if true */
        $Oformat2cole = false;	/* Format in output is two-column list, tab separated, with empty lines (to kolonner, tab separaret, med tomme linjer) if true */
        $Oformat3cole = false;	/* Format in output is three-column list, tab separated, with empty lines (tre kolonner, tab separaret, med tomme linjer) if true */
        $Oformat4cole = false;	/* Format in output is four-column list, tab separated, with empty lines (fire kolonner, tab separaret, med tomme linjer) if true */
