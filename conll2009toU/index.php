...
function scripinit($inputF,$input,$output)  /* Initialises outputfile. */
    {
    global $fscrip, $conll2009toUfile;
    $fscrip = fopen($conll2009toUfile,'w');
    if($fscrip)
        {
        fwrite($fscrip,"/*\n");
        fwrite($fscrip," * ToolID           : conll2009toU\n");
        fwrite($fscrip," * Version          : 1.0\n");
        fwrite($fscrip," * Title            : CoNLL 2009 to U\n");
        fwrite($fscrip," * ServiceURL       : http://localhost/conll2009toU\n");
        fwrite($fscrip," * Publisher        : CST\n");
        fwrite($fscrip," * ContentProvider  : CST\n");
        fwrite($fscrip," * Creator          : Bart Jongejan\n");
        fwrite($fscrip," * InfoAbout        : -\n");
        fwrite($fscrip," * Description      : Convert CoNLL 2009 (14 columns) to CoNLL-U (10 columns)\n");
...
function scrip($str) /* TODO send comments and command line instructions. Don't forget to terminate string with new line character, if needed.*/
    {
    global $fscrip, $conll2009toUfile;
    $fscrip = fopen($conll2009toUfile,'a');
    if($fscrip)
        {
        fwrite($fscrip,$str . "\n");
        fclose($fscrip);
...
*******************************/
        if( hasArgument("Iformatconll") )
            ...
            $input = $input . ($Iformatconllcnl2009 ? " \$Iformatconllcnl2009" : "") ;
            }
...
//        TODO your code!
        ...
        if($mode == 'dry')
            ...
            scrip("../bin/bracmat 'get\$\"conll2009toU.bra\"' '\$F' '\$conll2009toUfile'");
            }
        else
            {
