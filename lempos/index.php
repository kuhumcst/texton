       ...
       // if($F != '')
            ...
            if($Ilangbg)
                ...
                if($Iperiodc20 && $Operiodc20)
                    ...
                    $flexrules = "/opt/texton/res/web/da/lemmatiser/notags/c13-c18/2/flex.bra";
                    //$traindata = "/opt/texton/res/web/da/lemmatiser/training/guldkorpus-dsl-tabfile-B-2-4202-step2.4cole";
		    //$traindata = "/opt/texton/res/web/da/lemmatiser/training/guldkorpus-dsl-tabfile-C-1-4244-step2.4cole";
		    //$traindata = "/opt/texton/res/web/da/lemmatiser/training/guldkorpus-dsl-tabfile-D-3-4247-step2.4cole";
		    $traindata = "/opt/texton/res/web/da/lemmatiser/training/guldkorpus-dsl-tabfile-E-1-4251-step2.4cole";
                    }
                }
            if($Ilangde)
                {
                ...
                //$flexrules = "/opt/texton/res/web/nl/lemmatiser/notags/0/flexrules.elex.tab.ph_ziggurat_XS.bra";
                $traindata = "/opt/texton/res/web/nl/lemmatiser/training/dict_nl_without_doubles_UTF8.ph";
                //$traindata = "/opt/texton/res/web/nl/lemmatiser/training/elex.tab";
