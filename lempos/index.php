       ...
       // if($F != '')
            ...
            if($Ilangbg)
                ...
                if($Iperiodc20 && $Operiodc20)
                    ...
                    $traindata = "/opt/csttools/res/web/da/lemmatiser/training/tabfile.POS.ph";
                    }
                }
            if($Ilangde)
                {
        ...
        if($Oformatjson)
            ...
            if($Ifacetseto)
                $command = "/usr/local/bin/bracmat 'get\$\"/opt/csttools/lempos/LemmaVal.bra\"' '$traindata' 'onefile' '$F' '$flexrules' '$lemposfile' '$TorC'";
            else
                $command = "/usr/local/bin/bracmat 'get\$\"/opt/csttools/lempos/LemmaVal.bra\"' '$traindata' '$IfacetsegF' '$IfacettokF' '$flexrules' '$lemposfile' '$TorC'";
            logit($command);
