 ...
 */
        ...
        $Ifacet_lem_mrf_pos_tokF = "";	/* Input with type of content lemmas (Lemma) and morphological features (morfologiske træk) and PoS-tags (PoS-tags) and tokens (Tokens) */
        ...
        $Ifacet_lem_mrf_pos_tok = false;	/* Type of content in input is lemmas (Lemma) and morphological features (morfologiske træk) and PoS-tags (PoS-tags) and tokens (Tokens) if true */
        ...
        $Ifacet_lem_mrf_pos_tok__mrf_Menota = false;	/* Style of type of content lemmas (Lemma) and morphological features (morfologiske træk) and PoS-tags (PoS-tags) and tokens (Tokens) in input is Menota for the morphological features (morfologiske træk) component if true */
        $Ifacet_lem_mrf_pos_tok__pos_Menota = false;	/* Style of type of content lemmas (Lemma) and morphological features (morfologiske træk) and PoS-tags (PoS-tags) and tokens (Tokens) in input is Menota for the PoS-tags (PoS-tags) component if true */
...
*********/
        if( hasArgument("Ifacet_lem_mrf_pos_tokF") )
            ...
            if($Ifacet_lem_mrf_pos_tokF == '')
                {
                header("HTTP/1.0 404 Input with type of content 'lemmas (Lemma) and morphological features (morfologiske træk) and PoS-tags (PoS-tags) and tokens (Tokens)' not found (Ifacet_lem_mrf_pos_tokF parameter). ");
                return;
                }
        ...
        if( hasArgument("Ifacet_lem_pos_tokF") )
            ...
            if($Ifacet_lem_pos_tokF == '')
                {
                header("HTTP/1.0 404 Input with type of content 'lemmas (Lemma) and PoS-tags (PoS-tags) and tokens (Tokens)' not found (Ifacet_lem_pos_tokF parameter). ");
                return;
                }
