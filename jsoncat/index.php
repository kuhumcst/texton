...
Path in URL    : jsoncat	*** TODO make sure your web service listens on this path and that this script is readable for the webserver. ***
Publisher      : GitHub
...
function scripinit($inputF,$input,$output)  /* Initialises outputfile. */
    {
    global $fscrip, $jsoncatfile;
    $fscrip = fopen($jsoncatfile,'w');
    if($fscrip)
        {
        fwrite($fscrip,"/*\n");
        fwrite($fscrip," * ToolID           : jsoncat\n");
        fwrite($fscrip," * Version          : 0.7.1\n");
        fwrite($fscrip," * Title            : JSON pretty print\n");
        fwrite($fscrip," * ServiceURL       : http://localhost/jsoncat\n");
        fwrite($fscrip," * Publisher        : GitHub\n");
        fwrite($fscrip," * ContentProvider  : Gustavo Pantuza\n");
        fwrite($fscrip," * Creator          : Gustavo Pantuza\n");
        fwrite($fscrip," * InfoAbout        : https://github.com/pantuza/jsoncat\n");
        fwrite($fscrip," * Description      : Json pretty-print parser based on a recursive lexical analyser. The parser was based on the specification defined at json.org. The input file is parsed to build a json object. If the object is correct, it will be pretty-printed to standard output.\n");
