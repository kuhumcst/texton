...
ServiceURL     : http://localhost/conllout/	*** TODO make sure your web service listens on this address and that this script is readable for the webserver. ***
    ...
    function requestFile($requestParm) // e.g. "IfacettokF"
        ...
        if(isset($_REQUEST[$requestParm]))
            ...
            if($handle == false)
                ...
                {
                $tempfilename = tempFileName("conllout_$requestParm_");
...
************************/
        ...
        if( hasArgument("Ofacet") )
            ...
            $echos = $echos . "Ofacetseto=$Ofacetseto " . "Ofacetstp=$Ofacetstp " . "Ofacetstpl=$Ofacetstpl ";
            }
