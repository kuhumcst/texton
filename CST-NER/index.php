...
try {
    ...
    function navnegenkenderCSTNER($filename)
        ...
        if($mode == 'dry')
            {
                scrip("cd da/navnegenkenderCSTNER");
                scrip("perl CstNER.pl \$filename");
            }
        else
            {
            ...
            if($IfacetsegF != '')
                ...
                if($IfacettokF != '')
                    ...
                    if($mode == 'dry')
                    {
                        ...
                        scrip("\$nerfileRAW = navnegenkenderCSTNER(\$plaintext)");
                        navnegenkenderCSTNER("\$plaintext");
...
// START SPECIFIC CODE
    function combine($IfacettokF,$IfacetsegF)
        ...
        if($mode == 'dry')
        {
            $nerfile = "combine-tokseg-attribute";
            scrip("../bin/bracmat '(inputTok=\"\$IfacettokF\") (inputSeg=\"\$IfacetsegF\") (output=\"\$nerfile\") (lowercase=\"no\") (get\$\"../shared_scripts/tokseg2sent.bra\")'");
        }
        else
        {
    ...
    function NERannotation($IfacettokF,$nerfileRAW,$plaintext)
        ...
        if($mode == 'dry')
            ...
            scrip("../bin/bracmat '(inputTok=\"\$IfacettokF\") (inputNER=\"\$nerfileRAW\") (uploadfileTokens=\"\$plaintext\") (output=\"\$nerfile\") (get\$\"bracstnerf.bra\")'");
            }
        else
            {
